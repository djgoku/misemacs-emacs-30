...
#+begin_src sh
mise use packslip:github.com/djgoku/misemacs-emacs-30@latest
# Or pin a published release:
mise use packslip:github.com/djgoku/misemacs-emacs-30@YYYY.M.N
#+end_src
...
ln -sfn "$(dirname "$(mise where packslip:github.com/djgoku/misemacs-emacs-30)")/latest/misemacs/Emacs.app" ~/Applications/Emacs.app
#+end_src
...
packslip verify packslip.sigstore.json \
  --identity-prefix https://github.com/djgoku/misemacs-emacs-30/ \
